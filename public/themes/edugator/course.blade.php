                ...
                <div class="course-details-wrap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="course-whats-included-box course-widget p-4" style="border:2px solid #CFD4D8">
                                    ...
                                    <ul>
                                        <li class="mt-3 course-head-meta-wrap">
                                            <span><i class="la la-signal"></i> {{ course_levels($course->level) }}
                                            </span>
                                        </li>
                                        <li>
                                            <span class="created-by mr-3">
                                                <i class="la la-user"></i> {{ __t('created_by') }}
                                                {{ $course->author->name }}
                                            </span>
                                        </li>
                                        <li>
                                            <span class="last-updated-at">
                                                ...
                                                {{ __t('last_updated') }}
                                                {{ $course->last_updated_at->format(date_time_format()) }}
                                            </span>
                                        </li>
                                        <div>
                                            ...
                                            @if ($isEnrolled)
                                                <p class="text-muted"><strong>Enrolled At</strong> :
                                                    {{ date('F d, Y', strtotime($isEnrolled->enrolled_at)) }}
                                                </p>
                                            ...
                                            @else
                                                @if ($course->paid)
                                                    ...
                                                    <form action="{{ route('add_to_cart') }}" class="add_to_cart_form"
                                                        method="post">
                                                        @csrf
                                                ...
                                                @elseif($course->free)
                                                    <div class="course-landing-page-price-wrap" style="text-align: right">
                                                        {!! $course->price_html(false, true) !!}
                                                    </div>
                    ...
                    @if ($course->sections->count())
                        ...
                        <div class="course-curriculum-header d-flex mt-5">
                            <h4 class="mb-4 course-curriculum-title flex-grow-1">{{ __t('course_curriculum') }}
                            </h4>

                            <p id="expand-collapse-all-sections">
                                <a href="javascript:;" data-action="expand">Expand all</a>
                                <a href="javascript:;" data-action="collapse" style="display: none;">Collapse
                                    all</a>
                            </p>
