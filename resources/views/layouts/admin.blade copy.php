        ...
        <div class="container">
            <div class="dashboard-top-navbar-brand">
                <a class="navbar-brand" href="{{ route('home') }}">
                    ...
                    @if ($logoUrl)
                        <img style="height: 40px" src="{{ asset('assets/images/Logo-Mega.png') }}"
                ...
                <ul class="navbar-nav dashboard-navbar-icons mx-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard') }}" data-toggle="tooltip"
                            data-original-title="{{ __a('dashboard') }}"><i class="la la-dashboard"></i> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}" target="_blank" data-toggle="tooltip"
                            data-original-title="{{ __a('site_home') }}"><i class="la la-home"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('payments') }}" data-toggle="tooltip"
                            data-original-title="{{ __a('payments') }}">
                ...
                <div id="page-wrapper">
                    @if (!empty($title))
                        <div class="page-header px-4">
                            <h4 class="page-header-left"> @yield('title-before') {{ $title }}
                                @yield('title-after')
                            </h4>
